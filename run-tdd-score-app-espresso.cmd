...
call "%GRADLE_CMD%" :tdd-score-app:connectedDebugAndroidTest --no-daemon --no-configuration-cache --max-workers=1 -Dorg.gradle.java.installations.paths=F:\java\jdk-21.0.8 -Dfile.encoding=UTF-8 %AAPT2_ARG%
